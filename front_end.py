...
if __name__ == "__main__":
    try:
        input(
            ...
            '   ============================\n\n'
            'Create file named "MGMT.txt" containing list of management IP addresses for AP discovery within "Inputs" '
            'folder.\n'
        ...
        try:
            msg = f'\nDiscovery canceled by unknown exception: {e}\n'
            input(f"{logging.exception(msg)}\n\n"
                  'Press Enter to end.\n')
        except KeyboardInterrupt:
            print('\nForced exit.')
            pass
